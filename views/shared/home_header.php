      ...
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            ...
            <div class="col-md-9">
              <h3>Thank you for your participation in</h3>
        ...
        <!-- <a id="register" href="register" class="btn btn-register">REGISTER NOW</a> -->
  
      </div>
      <div class="clearfix"></div>
    </div>
    <div class="col-lg-12 sponsor-space" align="left">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" align="middle">
        <h3>Will be accessible on  August, 20<sup>th</sup> 2016</h3>
      </div>
