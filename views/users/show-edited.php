          ...
          <div class="profile-sidebar">
            ...
            <div class="profile-usermenu">
              <ul class="nav">
                ...
                <li><a href="setting"><i class="glyphicon glyphicon-user"></i>Edit Profile</a></li>
                <?php if($register->register_open): ?>
                  <?php if(!empty(end($user->participants))) { ?> 
                    ...
                    <?php if(!end($user->participants)->status): ?>
                      <li style="display:none;"><a href="edit-participant<?php echo end($user->participants)->id; ?>" ><i class="glyphicon glyphicon-user"></i>Edit participant </a></li>
                      <?php if(!empty(end($participant->race_packs))): ?>
                        <?php if(!empty(end(end($user->participants)->race_packs))): ?>
                          <li style="display:none;"><a href="edit-race-pack<?php echo end(end($user->participants)->race_packs)->id?>" ><i class="glyphicon glyphicon-ok">
                  ...
                  <?php } ?>
<?php if(empty(end($user->participants))): ?> 
               <!-- <li hidden><a href="participant-register" ><i class="glyphicon glyphicon-ok"></i>Register Event 2016 </a></li> -->
<?php endif; ?>
                <?php endif; ?>

                <li style="display:none;"><a href="add-races" ><i class="glyphicon glyphicon-ok"></i> Race History </a></li>
		  ...
		  <div>
            ...
            <p>
              <select class="form-control" name="run_category" id="run_category">
                <option value="">-----SELECT RUN CATEGORY-----</option>
                      ...
                      <div class="panel with-nav-tabs row custom-tabs">
                        <div class="panel-heading custom-tabs-head">
                          <ul class="nav nav-tabs custom-tabs-nav">
                            <li class="active"><a href="#tab4default" data-toggle="tab">Participant</a></li>
                            <li><a href="#tab1default" data-toggle="tab">DELIVERY</a></li>
                              ...
                              <table class="table table-user-information customspace">
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td class="airway-bill"><?php echo end(@$participant->race_packs)->noresi; ?></td>
                                  </tr>
                                  <?php } else { ?>
                                  <tr>
                                    <td><h4 class="minititle">Not found</h4></td>
                                  </tr>
                                  <?php } ?>
                                </tbody>
                              </table>
                                ...
                                <table class="table table-user-information customspace">
                                	<tbody>
                                    	<tr>
                                            ...
                                            <td><?php 
											$cat='';
											if((end($user->participants)->category_id)=='1'){
												$cat='5K';
											}
											else if((end($user->participants)->category_id)=='2'){
												$cat='10K';
											}
											else if((end($user->participants)->category_id)=='3'){
												$cat='17.8K';
											}
											echo $cat; 
                                    	...
                                    	<tr>
                                        	<td>ShirtSize</td>
                                            <td><?php echo (end($user->participants)->tshirt_size); ?></td>
                                        </tr>
                                    	<tr>
                                        	<td>BIB Name</td>
                                            <td><?php echo (end($user->participants)->bib_name); ?></td>
                                        </tr>
                                    	<tr>
                                        	<td>BIB Number</td>
                                            <td><?php echo (end($user->participants)->bib_number); ?></td>
                                        </tr>
                                    </tbody>
                                </table>    
                                </div>
  ...
  <?php if(!empty(end($user->race_events))): ?>
        ...
        $(function () {
          ...
          xAxis: {
            type: 'datetime',
              categories: [<?php echo implode(',',array_unique($year)); ?>],
          ...
          tooltip: {
            formatter: function() {
				var aaa = this.series.name ;
				var waktu = Highcharts.dateFormat('%H : %M : %S',new Date(aaa))
				
                return  '<b>' + this.series.name +'</b><br/>' +
                    Highcharts.dateFormat('%H : %M : %S',new Date(aaa));
				//return waktu;
			}
},
          legend: {
          ...
          series: [
	{
		"name":"BNI RUN", //lek nggak hardcode piye ?   // sakjane wis bener lo hmm // liat in // konvert data ke date time bener,
		"data":[1470098400,1470098400,1470098400] // tapi ...?  // strtotime kan buat convert English Time text ke UNIX Timestamp  // aku ga paham
	},
	{
		"name":"POCARI RUN",
		"data":[1470248100,1470438000,1470488400]
	}
]
        });
		//console.log('<?php echo implode(',',array_unique($year)); ?>');
