                ...
                <?php if($register->register_open): ?>
                  <?php if(!empty(end($user->participants))) { ?> 
                    ...
                    <?php if(!end($user->participants)->status): ?>
                      <li style=""><a href="edit-participant<?php echo end($user->participants)->id; ?>" ><i class="glyphicon glyphicon-user"></i>Edit participant </a></li>
  ...
  <?php if(!empty(end($user->race_events))): ?>
        ...
        labels: {
            formatter: function () {
				...
				var sec1=parseInt((parseInt(time%3600000))/60000/60);
                return (hours1 < 10 ? '0' + hours1 : hours1) + ':' + (mins1 < 10 ? '0' + mins1 : mins1) + ':' + (sec1 < 10 ? '0' + sec1 : sec1);
            }   
        }
    },
          tooltip: {
		  ...
		  //[{"name":"RUN 1","data":[247000,551000]},{"name":"RUN 2","data":[0,3600000]}]
        });
