 ...
 <div id="mws-container" class="clearfix">
  ...
  <div class="container">
    <div class="mws-panel-header">
      <span class="mws-i-24 i-list">New Delivery Price</span>
    </div>
      ...
      <div class="mws-form-block">
       <div class="mws-form-row">
        ...
        <div class="mws-form-item small">
         <input type="text" class="mws-textinput" name="price" />
       </div>
     </div>
     <div class="mws-form-row">
       <label>Event Date</label>
       <div class="mws-form-item small">
        <input type="text" class="mws-textinput" name="event_date" id='datepicker'/>
      </div>
    </div>
