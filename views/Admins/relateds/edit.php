 ...
 <div id="mws-container" class="clearfix">
  ...
  <div class="container">
    <div class="mws-panel-header">
      <span class="mws-i-24 i-list">Edit Related Information - <?php echo $related->name; ?></span>
    </div>
      ...
      <div class="mws-form-block">
       <div class="mws-form-row">
        ...
        <div class="mws-form-item small">
         <input type="text" class="mws-textinput" name="name" value="<?php echo $related->name; ?>"/>
       </div>
     </div>
