      ...
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            ...
            <div class="col-md-9">
              <h3>Terima kasih atas partisipasi anda di</h3>
       ...
       <!--  <a id="register" href="register" class="btn btn-register"> DAFTAR SEKARANG</a> -->
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" align="middle">
        <h3>Dapat diakses pada 20 Agustus 2016</h3>
      </div>
